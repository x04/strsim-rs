...
/// Calculates the Chapman Length Deviation for two strings.
///
/// ```
/// use strsim::chapman_length_deviation;
///
/// assert_eq!(1.0, chapman_length_deviation("", ""));
/// assert_eq!(0.5, chapman_length_deviation("", "a"));
/// assert_eq!(1.0, chapman_length_deviation("abc", "cba"));
/// assert_eq!(1.0, chapman_length_deviation("56068d1a-74c8-45b5-95db-dda01791f259", "7593ef1c-a6c0-4914-b4d8-d86c40fca45b"));
/// ```
pub fn chapman_length_deviation(a: &str, b: &str) -> f64 {
    if a.len() >= b.len() {
